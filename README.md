# Picons — 100x60 · Dark on Transparent
...
The workflow runs every **day at 05:00 UTC**. It only rebuilds PNGs whose source logo has changed since the last run; new logos are built automatically.
